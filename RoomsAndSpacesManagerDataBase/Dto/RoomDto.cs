...
namespace RoomsAndSpacesManagerDataBase.Dto
{
    ...
    public class RoomDto : ViewModel
    {
        ...
        public string Class_chistoti_SanPin
        {
            ...
            set => Set(ref class_chistoti_SanPin, value);
            
        }
        public string Class_chistoti_SP_158
        {
            get => class_chistoti_SP_158;
            set => Set(ref class_chistoti_SP_158, value);
            
        }
        public string Class_chistoti_GMP
        {
            get => class_chistoti_GMP;
            set => Set(ref class_chistoti_GMP, value);

        }
        public string T_calc
        {
            get => t_calc;
            set => Set(ref t_calc, value);
        }
        public string T_min
        {
            get => t_min;
            set => Set(ref t_min, value);
        }
        public string T_max
        {
            get => t_max;
            set => Set(ref t_max, value);
        }
        public string Pritok
        {
            get => pritok;
            set => Set(ref pritok, value);

        }
        public string Vityazhka
        {
            get => vityazhka;
            set => Set(ref vityazhka, value);

        }
        public string Ot_vlazhnost
        {
            get => ot_vlazhnost;
            set => Set(ref ot_vlazhnost, value);

        }
        public string KEO_est_osv
        {
            get => kEO_est_osv;
            set => Set(ref kEO_est_osv, value);
            
        }
        public string KEO_sovm_osv
        {
            get => kEO_sovm_osv;
            set => Set(ref kEO_sovm_osv, value);
            
        }
        public string Discription_OV
        {
            get => discription_OV;
            set => Set(ref discription_OV, value);
            
        }
        public string Osveshennost_pro_obshem_osvech
        {
            get => osveshennost_pro_obshem_osvech;
            set => Set(ref osveshennost_pro_obshem_osvech, value);
            
        }
        public string Group_el_bez
        {
            get => group_el_bez;
            set => Set(ref group_el_bez, value);
            
        }
        public string Discription_EOM
        {
            get => discription_EOM;
            set => Set(ref discription_EOM, value);
            
        }
        public string Discription_AR
        {
            get => discription_AR;
            set => Set(ref discription_AR, value);
            
        }
        public string Equipment_VK
        {
            get => equipment_VK;
            set => Set(ref equipment_VK, value);
            
        }
        public string Discription_SS
        {
            get => discription_SS;
            set => Set(ref discription_SS, value);
            
        }
        public string Discription_AK_ATH
        {
            get => discription_AK_ATH;
            set => Set(ref discription_AK_ATH, value);
            
        }
        public string Discription_GSV
        {
            get => discription_GSV;
            set => Set(ref discription_GSV, value);
            
        }
        public string Categoty_Chistoti_po_san_epid
        {
            get => categoty_Chistoti_po_san_epid;
            set => Set(ref categoty_Chistoti_po_san_epid, value);
            
        }
        public string Discription_HS
        {
            get => discription_HS;
            set => Set(ref discription_HS, value);
